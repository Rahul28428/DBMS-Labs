...
int main(){
    ...
    if (mysql_real_connect(conn, "localhost", "dbms_demo_vageesh_2", "DBMSDemo_vageesh_2", "dbms_demo_vageesh_2", 3306, NULL, 0)){
        ...
        snprintf(query, 256, "CREATE TABLE `%s` (`salesman_id` int NOT NULL PRIMARY KEY,`name` varchar(255),`adrress_city` varchar(255), `coverage_city` varchar(255),`commission` int);", tableName);
        ...
        snprintf(query1,256,"INSERT INTO `sales_table` (`salesman_id`, `name`, `address_city`, `coverage_city`, `commission`) VALUES ('1', 'Chakshu', 'Mumbai', 'Jodhpur', '1000'), ('2', 'Vageesh', 'Haryana', 'Delhi', '2000'), ('3', 'Rahul', 'Amravati', 'Nagpur', '1500'), ('4', 'Rushil', 'Thane', 'Jodhpur', '1000'), ('5', 'Kaustubh', 'Goa', 'Delhi', '1000'), ('6', 'Aman', 'Lucknow', 'Mumbai', '500');");
