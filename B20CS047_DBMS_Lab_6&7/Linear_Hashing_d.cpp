...
int main() 
{
    ...
    cout<<"Created Book Table Successfully! "<<endl;
	//*************************************************************************
	...
	cout<<endl;
	cout<<"Distributed Hashing:"<<endl<<endl;
	...
	for(auto i :A_book_purcahse){
		auto obj = i.second;
		if(obj.Purchase_Date == "Sep 5, 2022" && obj.Purchase_Date == "Sep 6, 2022" && obj.Purchase_Date == "Sep 7, 2022")cout<<obj.Book<<" "<<obj.Book_ID<<endl;
	}
	cout<<endl; 
